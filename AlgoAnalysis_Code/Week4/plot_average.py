...
file_handle = open("log_count_average.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_heap_average.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_insertion_average.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_merge_average.txt",  "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_quick_average.txt",  "r");
