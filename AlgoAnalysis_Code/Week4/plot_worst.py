...
file_handle = open("log_count_worst.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_heap_worst.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_insertion_worst.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_merge_worst.txt",  "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_quick_worst.txt",  "r");
