...
file_handle = open("log_array_asc.txt", "r");
...
plt.plot(x, y, c="orange", label="Array")
leg = plt.legend()
###
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_bst_asc.txt", "r");
...
y = []
#Initially printing and plotting the results of array in ascending order
file_handle = open("log_balanced_bst_asc.txt", "r");
